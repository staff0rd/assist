...
import type * as confirmMoveModule from "./move-repo/confirmMove";
...
vi.mock("./move-repo/confirmMove", async () => ({
	...(await vi.importActual<typeof confirmMoveModule>(
		"./move-repo/confirmMove",
	)),
	confirmMove: vi.fn(),
}));
...
import { confirmMove } from "./move-repo/confirmMove";
import { moveRepo } from "./moveRepo";
