export const expectedScripts: Record<string, string> = {
	...
	"verify:duplicate-code":
		"jscpd --format 'typescript,tsx' --exit-code 1 --ignore '**/*.test.*' -r consoleFull src",
	...
	"verify:circular-deps":
		"npx -y skott --displayMode=raw --showCircularDependencies --exitCodeOnCircularDependencies=1 src/index.ts",
};
